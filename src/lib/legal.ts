...
const privacyEn: LegalDoc = {
  ...
  intro:
    "This policy explains what Exact Try Out collects about you, why, how long it is kept, and how you can get it back or have it erased. It applies to everyone, wherever you live.",
  disclaimer:
  ...
  sections: [
    {
      ...
      body: [
        "Exact Try Out is operated by Exact Group. For anything in this policy, write to " + CONTACT + ".",
...
const privacyId: LegalDoc = {
  ...
  updated: LEGAL_UPDATED,
  intro:
    "Kebijakan ini menjelaskan data apa yang Exact Try Out kumpulkan tentang kamu, untuk apa, berapa lama disimpan, dan bagaimana kamu bisa mengambilnya kembali atau menghapusnya. Berlaku untuk semua pengguna, di mana pun kamu tinggal.",
  disclaimer:
  ...
  sections: [
    {
      ...
      body: [
        "Exact Try Out dioperasikan oleh Exact Group. Untuk hal apa pun dalam kebijakan ini, hubungi " + CONTACT + ".",
...
const privacyZh: LegalDoc = {
  ...
  updated: LEGAL_UPDATED,
  intro:
    "本政策说明 Exact Try Out 收集你的哪些信息、用途、保存期限，以及你如何取回或删除这些信息。无论你身在何处，本政策均适用。",
  disclaimer: "本文件是经过认真撰写的草稿，不构成法律意见。在依赖本文件之前，请交由所在司法辖区的执业律师审阅。",
  sections: [
    {
      heading: "一、责任主体",
      body: [
        "Exact Try Out 由 Exact Group 运营。与本政策有关的任何事宜，请联系 " + CONTACT + "。",
...
const termsEn: LegalDoc = {
  ...
  updated: LEGAL_UPDATED,
  intro: "These terms govern your use of Exact Try Out. By creating an account you agree to them.",
  disclaimer:
  ...
  sections: [
    {
      heading: "1. What Exact Try Out is — and is not",
      body: [
        "Exact Try Out is independent practice software. **We are not affiliated with, sponsored by, or endorsed by** College Board, Cambridge Assessment International Education, the China Scholarship Council, or the organisers of UTBK-SNBT.",
    ...
    },
    {
      ...
      body: [
        "A score produced by Exact Try Out is an estimate generated by our own model. It is not an official score, carries no weight with any university or examination board, and may differ from your result in the real exam.",
...
const termsId: LegalDoc = {
  ...
  updated: LEGAL_UPDATED,
  intro: "Ketentuan ini mengatur penggunaanmu atas Exact Try Out. Dengan membuat akun, kamu menyetujuinya.",
  disclaimer:
  ...
  sections: [
    {
      heading: "1. Apa itu Exact Try Out — dan apa yang bukan",
      body: [
        "Exact Try Out adalah perangkat lunak latihan yang independen. **Kami tidak berafiliasi dengan, tidak disponsori oleh, dan tidak didukung oleh** College Board, Cambridge Assessment International Education, China Scholarship Council, maupun penyelenggara UTBK-SNBT.",
    ...
    },
    {
      ...
      body: [
        "Skor yang dihasilkan Exact Try Out adalah estimasi dari model kami sendiri. Ia bukan skor resmi, tidak memiliki bobot apa pun di mata universitas atau badan ujian, dan bisa berbeda dari hasilmu di ujian sesungguhnya.",
...
const termsZh: LegalDoc = {
  title: "服务条款",
  updated: LEGAL_UPDATED,
  intro: "本条款约束你对 Exact Try Out 的使用。创建账号即表示你同意本条款。",
  disclaimer: "本文件是经过认真撰写的草稿，不构成法律意见。在开始收款之前，请交由执业律师审阅。",
  sections: [
    {
      heading: "一、Exact Try Out 是什么，不是什么",
      body: [
        "Exact Try Out 是独立的备考练习软件。我们与 College Board、剑桥国际考评部、中国国家留学基金管理委员会及 UTBK-SNBT 主办方**均无隶属、赞助或背书关系**。",
    ...
    },
    {
      ...
      body: [
        "Exact Try Out 给出的分数是我们自有模型的估算值。它不是官方成绩，对任何大学或考试机构均无效力，也可能与你在真实考试中的结果不同。",
